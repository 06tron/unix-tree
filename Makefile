# Copyright (c) 1996-2026, Steve Baker (steve.baker.llc@gmail.com).

# Option to test HTML output added by Matthew Richardson
...
test:
	tree -H '' data:test-filename > test-filenames.html
