...
char *version = "$Version: $ tree v2.3.1-pct-encode %s 1996 - 2026 by Steve Baker, Thomas Moore, Francesc Rocher, Florian Sesser, Kyosuke Tokoro $";
char *hversion= "\t\t tree v2.3.1-pct-encode %s 1996 - 2026 by Steve Baker and Thomas Moore <br>\n"
